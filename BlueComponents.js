...
export class BlueBitcoinAmount extends Component {
  ...
  onAmountUnitChange(previousUnit, newUnit) {
    ...
    switch (previousUnit) {
      ...
      //   sats = new BigNumber(currency.fiatTARbtc(amount)).multipliedBy(100000000).toString();
      //   break;
    }
  ...
  render() {
    ...
    switch (this.state.unit) {
      ...
      case BitcoinUnit.SATS:
        ...
        break;
      // case BitcoinUnit.LOCAL_CURRENCY:
      //   secondaryDisplayCurrency = currency.fiatTARbtc(parseFloat(isNaN(amount) ? 0 : amount));
      ...
      //     secondaryDisplayCurrency = currency.satoshiTARbtc(sats);
      //   }
      //   break;
    }
